		...
		<div class="container" id="about">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6 about-left ">
					<img class="img-fluid" src="https://i.imgur.com/0AZzx5q.jpg" alt="">
				</div>
				<div class="col-lg-6 col-md-12 about-right">
					...
					<div class="mb-50 wow fadeIn" data-wow-duration=".8s">
							<h3>We have great clients, and they have great stories to tell. We look forward to learning about yours.</h3>
							<p>
							<div class="devider"></div>
							iBrand Africa has provided branding, web design and digital marketing for clients across the continent since 2011. Our founders and experts are industry veterans with years of experience building enduring brands. Today, iBrand’s team of strategists, writers, designers, and developers in Accra, Port Harcourt and Lagos share a passion for creative branding and translating stories into engaging user experiences.
						</p>
					</div>
				</div>
			</div>
	...
	<section class="section" >
      <div class="container" id="team">
        <div class="main-title text-center mb-5 col about-center">
          <h1>Meet the team</h1>
		      <p class="col-lg-6">A brand is more than a logo or website. It’s a story weaved together
        ...
        <div class="section__content teamy-team">
          ...
          <article class="teamy teamy_style1 teamy_mask-triangle teamy_zoom-rotate-photo">
            <div class="teamy__layout">
              <div class="teamy__preview">
                <img src="https://i.imgur.com/KidP8wM.jpg" class="teamy__avatar" alt="The demo photo">
              </div>
              <div class="teamy__back">
                <div class="teamy__back-inner">
                  <a href="#0" class="social">
            ...
            <div class="teamy__content">
              <h3 class="teamy__name">Bright Stephen</h3>
              <span class="teamy__post">Full Stack Developer</span>
            </div>
          </article>
          <article class="teamy teamy_style1 teamy_mask-triangle teamy_zoom-slide-photo">
            ...
            <div class="teamy__content">
              <h3 class="teamy__name">Henry Dennis</h3>
		...
		<article class="teamy teamy_style1 teamy_mask-triangle teamy_zoom-slide-photo">
            <div class="teamy__layout">
              <div class="teamy__preview">
                <img src="https://i.imgur.com/9C8OuWE.jpg" class="teamy__avatar" alt="The demo photo">
              </div>
              <div class="teamy__back">
                <div class="teamy__back-inner">
                  <a href="#0" class="social">
            ...
            <div class="teamy__content">
              <h3 class="teamy__name">Somiari Lucky</h3>
              <span class="teamy__post">UI/UX Designer</span>
            </div>
          </article>
		<article class="teamy teamy_style1 teamy_mask-triangle teamy_zoom-slide-photo">
            <div class="teamy__layout">
              <div class="teamy__preview">
                <img src="https://i.imgur.com/dDvX8pd.jpg" class="teamy__avatar" alt="The demo photo">
              </div>
              <div class="teamy__back">
                <div class="teamy__back-inner">
                  <a href="#0" class="social">
            ...
            <div class="teamy__content">
              <h3 class="teamy__name">Peter Peregbakumo</h3>
              <span class="teamy__post">Full Stack developer & Media</span>
            </div>
          </article>
		<article class="teamy teamy_style1 teamy_mask-triangle teamy_zoom-slide-photo">
            <div class="teamy__layout">
              <div class="teamy__preview">
                <img src="https://i.imgur.com/chxHbJZ.jpg" class="teamy__avatar" alt="The demo photo">
              </div>
              <div class="teamy__back">
                <div class="teamy__back-inner">
                  <a href="#0" class="social">
            ...
            <div class="teamy__content">
              <h3 class="teamy__name"> Ibiba Banigo</h3>
		...
		<article class="teamy teamy_style1 teamy_mask-triangle teamy_zoom-slide-photo">
            <div class="teamy__layout">
              <div class="teamy__preview">
                <img src="https://i.imgur.com/HX5UQmv.jpg" class="teamy__avatar" alt="The demo photo">
              </div>
              <div class="teamy__back">
                <div class="teamy__back-inner">
                  <a href="#0" class="social">
            ...
            <div class="teamy__content">
              <h3 class="teamy__name">Samuel Ike</h3>
              <span class="teamy__post">Media</span>
            </div>
          </article>
          ...
          <article class="teamy teamy_style1 teamy_mask-triangle teamy_zoom-slide-photo">
            <div class="teamy__layout">
              <div class="teamy__preview">
                <img src="https://i.imgur.com/UvVt0HX.jpg" class="teamy__avatar" alt="The demo photo">
              </div>
              <div class="teamy__back">
                <div class="teamy__back-inner">
                  <a href="#0" class="social">
            ...
            <div class="teamy__content">
              <h3 class="teamy__name">Edwin Minimah</h3>
              <span class="teamy__post">brand Artist</span>
            </div>
          </article>
<!-- replacement needed here========================================= -->
          ...
          <article class="teamy teamy_style1 teamy_mask-triangle teamy_zoom-slide-photo">
          	<div class="teamy__layout">
          		<div class="teamy__preview">
          			<img src="https://i.imgur.com/bPaYw5H.jpg" class="teamy__avatar" alt="The demo photo">
          		</div>
          		<div class="teamy__back">
          			<div class="teamy__back-inner">
          				<a href="#0" class="social">
          	...
          	<div class="teamy__content">
          		<h3 class="teamy__name">Lisa Michael</h3>
          		<span class="teamy__post">Frontend Stack Developer</span>
          	</div>
          </article>
          <article class="teamy teamy_style1 teamy_mask-triangle teamy_zoom-slide-photo">
          	<div class="teamy__layout">
          		<div class="teamy__preview">
          			<img src="https://i.imgur.com/TqsUpqI.jpg" class="teamy__avatar" alt="The demo photo">
          		</div>
          		<div class="teamy__back">
          			<div class="teamy__back-inner">
          				<a href="#0" class="social">
          	...
          	<div class="teamy__content">
          		<h3 class="teamy__name">Andrew Kennedy</h3>
          		<span class="teamy__post">Communication /Resource Developer</span>
          	</div>
          </article>
          <article class="teamy teamy_style1 teamy_mask-triangle teamy_zoom-slide-photo">
          	<div class="teamy__layout">
          		<div class="teamy__preview">
          			<img src="https://i.imgur.com/WLxD6qf.jpg" class="teamy__avatar" alt="The demo photo">
          		</div>
          		<div class="teamy__back">
          			<div class="teamy__back-inner">
          				<a href="#0" class="social">
          	...
          	<div class="teamy__content">
          		<h3 class="teamy__name">Edwin Johnson</h3>
          		<span class="teamy__post">UX /UI Designer /Content Developer</span>
          	</div>
          </article>
