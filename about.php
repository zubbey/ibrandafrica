				...
				<div class="col-xs-12 no-padd">
					<div class="container-fluid top-banner top-banner__scene style2 medium_banner center_content simple">
						...
						<div class="content">
							<div class="row">
								<div class="col-xs-12">
									<h3 class="title">We are a creative agency</h3>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="wpb_text_column wpb_content_element " >
									<div class="wpb_wrapper">
										<h3 style="text-align: center;"><strong>We've been in business since 2011,<br/></strong>
											...
											<p>Today, iBrand’s team of strategists, writers, designers, and developers in Accra, Port Harcourt and Lagos share
												a passion for creative branding and translating stories into engaging user experiences.
							...
							<div class="row">
								<div class="col-xs-12 no-padd">
									<div class="single-image">
										<div class="grid-item"><img src="https://i.imgur.com/NW74qu3.jpg" alt=""></div>
										<div class="grid-item"><img src="https://i.imgur.com/aEwkFrE.jpg" alt="" class="s-img-switch"></div>
									</div>
								</div>
							</div>
						</div>
