...
<main class="container">
    <div class="section__block" style="margin-top: 20%; margin-bottom: 10%;">
        <form method="POST" action="'.htmlspecialchars($_SERVER["PHP_SELF"]).'">
            <div class="row">
                <div class="form-group col-md-6 m-auto">
                    <h2 class="page-title">Admin Login Portal</h2>
                    '.$invalid_entry_Msg.'
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary btn-lg btn-round" name="login-btn" type="submit">Login <i class="nc-icon nc-lock-circle-open"></i></button>
                    </div>
                </div>
            </div>
        </form>
