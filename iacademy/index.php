      ...
      <div class="row align-items-center no-gutters mb-4 mb-lg-5">
        ...
        <div class="col-xl-4 col-lg-5">
          <div class="featured-text text-center text-lg-left">
            <h2>Our Vision</h2>
            <p class="text-black-50">iBrand Academy  aspires to be the design academy  of choice in Africa by providing an international learning environment encompassing innovation and knowledge to contribute to the advancement of humanity.</p>
          </div>
        </div>
      </div>
      ...
      <nav class="" aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
          <li class="page-item disabled" id="p">
            <a class="page-link js-scroll-trigger" id="previous" href="#courses" tabindex="-1" style="border-top-left-radius:20px;border-bottom-left-radius:20px">Previous <span class="lnr lnr-arrow-left"></span></a>
          </li>
          <li class="page-item" id="n">
            <a class="page-link js-scroll-trigger" id="next" href="#courses" style="border-bottom-right-radius:20px;border-top-right-radius:20px;">Next <span class="lnr lnr-arrow-right"></span></a>
          </li>
        </ul>
      </nav>
...
// define variables and set to empty values
    ...
    <!-- <section class="gallery-section">
      <div class="container">
        <h2 class=" mt-5"> Our Past Interns</h2>
  ...
  <?php require_once'tawkto.php'; ?>
    ...
    <footer class=" text-center text-white-50">
      <div class="container" >
        <p class="h5">Powered By &copy; <a href='ibrandafrica.com' target="_blank" style="color: #00aabd">iBrand Africa</a></p>
      </div>
    </footer>
