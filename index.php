			...
			<div class="container">
				<div class="row fullscreen d-flex align-items-center">
					<div class="banner-content col-lg-12 justify-content-center">
						...
						<h3 class="col-5">We are a branding, IT and marketing agency with one goal… we help businesses stand out and grow</h3>
			...
			<div class="container">
				<div class="row fullscreen d-flex align-items-center">
					<div class="banner-content col-lg-12 justify-content-center">
						...
						<h3 class="col-5">Our creative energy shapes the ideas that transforms brands and creates connections with customers and audiences.</h3>
			...
			<div class="container">
				<div class="row fullscreen justify-content-endd-flex align-items-center">
					<div class="banner-content col-lg-12 justify-content-center">
						...
						<h3 class="col-5">A strong brand confirms your credibility, creates loyalty, connects emotionally with your consumers,
and motivates your audience to choose your services.</h3>
		...
		<div class="single_slide_banner slide_bg4">
			<div class="container">
				<div class="row fullscreen justify-content-endd-flex align-items-center">
					<div class="banner-content col-lg-12 justify-content-center">
						...
						<h3 class="col-5 text-white">Join a vibrant, creative and award-winning student community.</h3>
    ...
    <div class="container text-center">
        ...
        <div class="section__content teamy-team">
              ...
              <article class="teamy teamy_style1 teamy_mask-triangle teamy_zoom-rotate-photo">
                ...
                <div class="teamy__content">
                  <h3 class="teamy__name">Bright Mathew</h3>
